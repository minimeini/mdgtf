...
opts.tfs$use_discount <- TRUE
opts.tfs$use_custom <- TRUE
opts.tfs$custom_discount_factor <- 0.996
...
if (save_data) {
    save(
        out.tfs, out.tfs2, opts.tfs, delta.tfs, W.tfs,
        file = file.path(
            opath, "data",
