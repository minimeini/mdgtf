...
dat = read.csv("/Users/meinitang/Downloads/prior-sensitivity-w-pl-sim-3269.csv")
...
fname = paste0("prior-sensitivity-w-pl-", data_type, "-", tag, ".csv")
