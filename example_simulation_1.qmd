...
#| include: false
#| eval: false
opts1.hva$mu0$infer <- TRUE
opts1.hva$W$infer <- FALSE
opts1.hva$rho$infer <- FALSE
opts1.hva$par1$infer <- FALSE
opts1.hva$par2$infer <- FALSE
...
mod1$dim$regressor_baseline <- FALSE
