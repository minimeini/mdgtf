...
if (save_data) {
    if (exists("out1.tfs") & exists("out1.tfs2")) {
        save(
            out1.tfs, out1.tfs2, opts1.tfs,
            file = file.path(
                opath, "data",
                paste0("sim-", seed, "-tfs.RData")
            )
        )
    } else if (exists("out1.tfs")) {
        save(
            out1.tfs, opts1.tfs,
            file = file.path(
                opath, "data",
...
opts1.hva$mcs$num_particle <- 500
