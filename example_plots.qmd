...
p <- plot_ts_ci_multi(
    list(
        LBA = log(exp(sim1.dat$out1.lba$fit$psi[tstart:tend, ]) + 1),
        MCS = log(exp(sim1.dat$out1.mcs$fit$psi[tstart:tend, ]) + 1),
        FFBS = log(exp(sim1.dat$out1.ffbs$fit$psi[tstart:tend, ]) + 1),
        PL = log(exp(sim1.dat$out1.pl$fit$psi[tstart:tend, ]) + 1),
