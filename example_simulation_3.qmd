...
opts1.lba$use_discount <- TRUE
opts1.lba$use_custom <- TRUE
opts1.lba$custom_discount_factor <- 0.92
```
...
out1.lba2.loss_all <- c(
    c(out1.lba2$error$forecast$y_loss_all),
    out1.lba2$error$fitted$filter$y_loss_all,
    out1.lba2$error$fitted$smooth$y_loss_all
)

names(out1.lba2.loss_all) <- c(
    paste0("forecast", 1:length(c(out1.lba2$error$forecast$y_loss_all))),
    "fitted-filter", "fitted-smooth"
)
...
opts1.mcs$use_discount <- TRUE
opts1.mcs$use_custom <- TRUE
opts1.mcs$custom_discount_factor <- 0.92
...
out1.mcs2.loss_all <- c(
    c(out1.mcs2$error$forecast$y_loss_all),
    c(out1.mcs2$error$fitted$filter$y_loss_all),
    c(out1.mcs2$error$fitted$smooth$y_loss_all)
)
names(out1.mcs2.loss_all) <- c(
    paste0("forecast", 1:length(c(out1.mcs2$error$forecast$y_loss_all))),
    "fitted-filter", "fitted-smooth"
)
...
opts1.ffbs$use_discount <- TRUE
opts1.ffbs$use_custom <- TRUE
opts1.ffbs$custom_discount_factor <- 0.95
...
out1.ffbs2.loss_all <- c(
    c(out1.ffbs2$error$forecast$y_loss_all),
    out1.ffbs2$error$fitted$filter$y_loss_all,
    out1.ffbs2$error$fitted$smooth$y_loss_all
)
names(out1.ffbs2.loss_all) <- c(
    paste0("forecast", 1:length(out1.ffbs2$error$forecast$y_loss_all)),
    "fitted-filter", "fitted-smooth"
)
...
out1.hva.loss_all = c(
  c(out1.hva$error$forecast$y_loss_all),
  c(out1.hva$error$fitted$y_loss_all)
)
