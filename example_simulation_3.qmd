...
opts1.mcs$use_discount <- TRUE
opts1.mcs$use_custom <- TRUE
opts1.mcs$custom_discount_factor <- 0.95
...
p6 = ggplot(data.frame(mu0 = c(out1.mcs$fit$mu0)), aes(x = mu0)) +
    stat_bin(bins=50) + theme_light()
...
opts1.ffbs$use_discount <- TRUE
opts1.ffbs$use_custom <- TRUE
opts1.ffbs$custom_discount_factor <- 0.94
