...
opts.hva$W$init <- mod$param$err[1]
opts.hva$W$infer <- "W" %in% param_infer
...
```{r}
#| label: save hva data
if (exists("out.hva") && exists("out.hva2")) {
    if (save_data) {
        save(
            out.hva, opts.hva,
            out.hva2, opts.hva2,
