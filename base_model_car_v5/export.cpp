...
)
{
    ...
    arma::vec psi1_spatial, psi2_temporal, psi3_spatial, psi4_temporal;
    model.simulate(
        Y, Lambda, 
        psi2_temporal, psi4_temporal, 
        psi1_spatial, psi3_spatial,
        wt, log_a, ntime
    );
    ...
    return Rcpp::List::create(
        ...
        Rcpp::Named("psi3_spatial") = psi3_spatial,
        Rcpp::Named("psi4_temporal") = psi4_temporal,
        Rcpp::Named("wt") = wt,
